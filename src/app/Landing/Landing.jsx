        ...
        <Slider {...carouselSettings}>
          <div className="relative rounded-lg ">
            <img
              ...
              height={232}
              alt="Producto 1"
              className="w-full rounded-3xl h-58"
            />
            <div className="">
              <p className=""></p>
            </div>
          ...
          <div>
            <img
              src="https://storage.googleapis.com/tradeinn-images/images/landing-pages/eng_appleLP-6.jpg"
              width={800}
              height={232}
              alt="Producto 2"
              className="w-full rounded-3xl h-58"
      ...
      <section className="featured-products p-6 w-full max-w-6xl mt-3 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="product-card bg-white p-4 rounded-lg shadow-md text-center">
            <img
              src={"https://i.ebayimg.com/images/g/1WkAAOSwcrphzWAR/s-l400.jpg"}
              alt="Computadoras"
              className="w-svw"
            />
            <h3 className="text-xl text-black font-semibold mb-2">COMPUTADORAS</h3>
            <p className="text-gray-700 mb-5">
              Encuentra la mejor selección de computadoras de última generación.
            </p>
          </div>
          <div className="product-card bg-white p-4 rounded-lg shadow-md text-center">
            <img
              src={"https://images.fravega.com/f500/60377252c47a065e4a6bb55660950386.jpg"}
              alt="Celulares"
              className="w-svw mx-auto"
            />
            <h3 className="text-xl text-black font-semibold mb-2">CELULARES</h3>
            <p className="text-gray-700 mb-4">
              Explora nuestra variedad de celulares con la tecnología más avanzada.
            </p>
          </div>
          <div className="product-card bg-white p-4 rounded-lg shadow-md text-center">
            <img
              src={"https://i5.walmartimages.com/asr/2830c8d7-292d-4b99-b92f-239b15ff1062.ce77d20b2f20a569bfd656d05ca89f7c.jpeg"}
              alt="AirPods"
              className="w-svw mx-auto mb-2"
            />
      ...
      <section className="payment-methods bg-gray-900 p-6 w-full max-w-6xl mt-10 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="flex-1 payment-card bg-white p-4 rounded-lg shadow-md text-center">
            <img
              src="//static.vecteezy.com/system/resources/previews/010/287/597/non_2x/wallet-icon-isolated-on-a-white-background-wallet-earnings-and-money-symbols-for-web-and-mobile-apps-free-vector.jpg"
          ...
          <div className="payment-card bg-white p-4 rounded-lg shadow-md text-center">
            <img
              src="//Image.freepik.com/vector-premium/icono-billetera-simbolo-dolar-icono-vector-billetera-digital-signo-estilo-lineal-concepto-movil_615232-309.jpg"
              alt="Efectivo"
              className="mt-2 w-36 h-34 mx-auto mb-4"
            />
          ...
          <div className="payment-card bg-white p-4 rounded-lg shadow-md text-center">
            <img
              src="//static.vecteezy.com/system/resources/previews/014/581/558/non_2x/smartphone-digital-wallet-icon-simple-style-vector.jpg"
